        ...
        <div className="grid grid-cols-12 gap-[70px] mb-[140px]">
          ...
          <div className="col-span-4 bg-lightblue p-4 text-center">
            ...
            <div className="w-full text-left space-y-4">
              <h1 className="text-2xl font-bold mb-[16px]">Product Title</h1>
              ...
              <p className="text-2xl font-normal mb-[24px]">$99.99</p>
              ...
              <div className="flex flex-col border border-[#00000080] rounded">
