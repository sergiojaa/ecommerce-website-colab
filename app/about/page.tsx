...
export default function about() {
  ...
  return (
    <div>
      <div className="flex justify-between mx-auto items-center w-[1280px] mt-[80px]">
      ...
      <div className="flex items-center justify-center gap-12 mt-28">
        <div
          ...
          className={`border cursor-pointer mb-10 justify-center gap-3 flex flex-col items-center h-[200px] w-[230px] border-black ${
            activeDiv === 0 ? "bg-red-500" : ""
          }`}
        >
